...
PREDEFINED_PROMPTS = {
    ...
    """,
    "3. 연구 배경": """
    제공된 정보를 바탕으로 연구의 배경을 1000자 이내로 설명해주세요. 어미는 반드시 반말 문어체로 합니다. (예: ~하였다. ~있다. ~있었다)
    다음 사항을 포함하세요:
    1. 이론적 배경 및 근거
    2. 선행 연구 및 결과
...
""",
        "6. 자료분석과 통계적 방법": """
    이전 섹션의 내용을 바탕으로 자료분석과 통계적 방법을 1000자 이내로 작성해주세요. 어미는 반말 문어체로 합니다. (예: ~하였다. ~있다. ~있었다) 다음 사항을 포함해야 합니다:
    ...
    """,
        "7. 연구방법": """
    2번부터 6번까지의 섹션 내용을 바탕으로 전체 연구방법을 500자 이내로 요약해주세요. 어미는 반말 문어체로 합니다. (예: ~하였다. ~있다. ~있었다) 다음 사항을 포함해야 합니다:
